...
TEST_F(CPUTests, rorAccWorks)
{
	...
	constexpr u8 inputValue = 0b0110'0100;
	constexpr u8 targetValue = 0b1011'0010;
	constexpr s32 targetCycles = ROR_ACC.cycles;

	// Load to A
	memory[TEST_MAIN_ADDRESS] = ROR_ACC.opcode;
	cpu.setA(inputValue);
	cpu.setC(1);
...
TEST_F(CPUTests, rorAccNegWorks)
{
	// Target values
	const CPU cpuInitialState = cpu;
	constexpr u8 inputValue = 0b0010'0000;
	constexpr u8 targetValue = 0b1001'0000;
	constexpr s32 targetCycles = ROR_ACC.cycles;
...
{	
	// Target values
	const CPU cpuInitialState = cpu;
	constexpr u8 inputValue = 0b0000'0001;
...
TEST_F(CPUTests, rorZPWorks)
{
	...
	constexpr u8 inputValue = 0b0110'0100;
	constexpr u8 targetValue = 0b1011'0010;
	constexpr s32 targetCycles = ROR_ZP.cycles;

	// Load to A
	memory[TEST_MAIN_ADDRESS] = ROR_ZP.opcode;
...
TEST_F(CPUTests, rorZPXWorks)
{
	...
	constexpr u8 inputValue = 0b0110'0100;
	constexpr u8 targetValue = 0b1011'0010;
	constexpr s32 targetCycles = ROR_ZPX.cycles;

	// Load to A
	cpu.setX(xValue);
	memory[TEST_MAIN_ADDRESS] = ROR_ZPX.opcode;
	memory[TEST_MAIN_ADDRESS + 1] = zpAddress;
...
TEST_F(CPUTests, rorAbsWorks)
{
	...
	constexpr u8 inputValue = 0b0110'0100;
	constexpr u8 targetValue = 0b1011'0010;
	constexpr s32 targetCycles = ROR_ABS.cycles;

	// Load to A
	memory[TEST_MAIN_ADDRESS] = ROR_ABS.opcode;
...
TEST_F(CPUTests, rorAbsXWorks)
{
	...
	constexpr u8 inputValue = 0b0110'0100;
	constexpr u8 targetValue = 0b1011'0010;
	constexpr s32 targetCycles = ROR_ABSX.cycles;

	// Load to A
	cpu.setX(xValue);
	memory[TEST_MAIN_ADDRESS] = ROR_ABSX.opcode;
	memory[TEST_MAIN_ADDRESS + 1] = addressLsb;
	memory[TEST_MAIN_ADDRESS + 2] = addressMsb;
	memory[address] = inputValue;
	cpu.setC(1);
