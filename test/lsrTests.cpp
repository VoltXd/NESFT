...
TEST_F(CPUTests, lsrAccWorks)
{
	...
	constexpr s32 targetCycles = LSR_ACC.cycles;
...
TEST_F(CPUTests, lsrZPWorks)
{
	...
	constexpr u8 inputValue = 0b0110'0100;
	constexpr u8 targetValue = 0b0011'0010;
	constexpr s32 targetCycles = LSR_ZP.cycles;
...
TEST_F(CPUTests, lsrZPXWorks)
{
	...
	constexpr u8 inputValue = 0b0110'0100;
	constexpr u8 targetValue = 0b0011'0010;
	constexpr s32 targetCycles = LSR_ZPX.cycles;
...
TEST_F(CPUTests, lsrAbsWorks)
{
	...
	constexpr u8 inputValue = 0b0110'0100;
	constexpr u8 targetValue = 0b0011'0010;
	constexpr s32 targetCycles = LSR_ABS.cycles;
...
TEST_F(CPUTests, lsrAbsXWorks)
{
	...
	constexpr u8 inputValue = 0b0110'0100;
	constexpr u8 targetValue = 0b0011'0010;
	constexpr s32 targetCycles = LSR_ABSX.cycles;
